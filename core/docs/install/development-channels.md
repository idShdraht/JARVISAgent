...
JARVIS ships three update channels:
...
When you **explicitly** switch channels with `--channel`, JARVIS also aligns
the install method:
...
When you switch channels with `jarvis update`, JARVIS also syncs plugin sources:

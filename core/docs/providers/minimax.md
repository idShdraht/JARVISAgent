---
summary: "Use MiniMax M2.1 in JARVIS"
read_when:
...
- Use `jarvis models list` and `jarvis models set minimax/MiniMax-M2.1` to switch.
...
- Running `jarvis configure` and selecting **MiniMax M2.1**, or

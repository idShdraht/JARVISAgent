---
summary: "Use NVIDIA's OpenAI-compatible API in JARVIS"
read_when:
  - You want to use NVIDIA models in JARVIS
...
jarvis onboard --auth-choice skip
jarvis models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```

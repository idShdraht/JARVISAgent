---
summary: "Use Qianfan's unified API to access many models in JARVIS"
read_when:
...
3. JARVIS installed on your system
...
4. Copy the API key for use with JARVIS

## CLI setup

```bash
jarvis onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [JARVIS Configuration](/gateway/configuration)

---
summary: "Use Synthetic's Anthropic-compatible API in JARVIS"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. JARVIS registers it as the
...
Note: JARVIS's Anthropic client appends `/v1` to the base URL, so use

---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with JARVIS"
read_when:
  - You want Xiaomi MiMo models in JARVIS
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). JARVIS uses

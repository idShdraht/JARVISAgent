...
Deepgram is a speech-to-text API. In JARVIS it is used for **inbound audio/voice note
transcription** via `tools.media.audio`.

When enabled, JARVIS uploads the audio file to Deepgram and injects the transcript

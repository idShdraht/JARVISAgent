---
summary: "Use Qwen OAuth (free tier) in JARVIS"
read_when:
  - You want to use Qwen with JARVIS
...
If you already logged in with the Qwen Code CLI, JARVIS will sync credentials

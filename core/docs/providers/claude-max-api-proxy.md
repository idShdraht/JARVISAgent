...
You can point JARVIS at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or JARVIS
...
- [Anthropic provider](/providers/anthropic) - Native JARVIS integration with Claude setup-token or API keys

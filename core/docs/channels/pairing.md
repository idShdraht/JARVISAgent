...
read_when:
  ...
  - Reviewing JARVIS security posture
title: "Pairing"
---

# Pairing

“Pairing” is JARVIS’s explicit **owner approval** step.
...
3. On your phone, open the JARVIS iOS app → Settings → Gateway.
...
- The legacy `node.pair.*` API (CLI: `jarvis nodes pending/approve`) is a

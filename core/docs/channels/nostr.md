...
read_when:
  - You want JARVIS to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables JARVIS to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`jarvis onboard`) and `jarvis channels add` list optional channel plugins.

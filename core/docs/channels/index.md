---
summary: "Messaging platforms JARVIS can connect to"
read_when:
  - You want to choose a chat channel for JARVIS
...
- Channels can run simultaneously; configure multiple and JARVIS will route per chat.

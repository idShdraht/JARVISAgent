...
- Install via CLI: `jarvis plugins install @jarvis/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `jarvis plugins install ./extensions/zalo`
   - From npm (if published): `jarvis plugins install @jarvis/zalo`
...
- Approve via:
  - `jarvis pairing list zalo`
  - `jarvis pairing approve zalo <CODE>`
...
- Example: `jarvis message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `jarvis channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `jarvis logs --follow`

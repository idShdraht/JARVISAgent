...
JARVIS treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.jarvis/settings/voicewake.json`

Shape:

```json
{ "triggers": ["jarvis", "claude", "computer"], "updatedAtMs": 1730000000000 }
```

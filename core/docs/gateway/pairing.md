...
Pairing state is stored under the Gateway state directory (default `~/.jarvis`):

- `~/.jarvis/nodes/paired.json`
- `~/.jarvis/nodes/pending.json`

If you override `JARVIS_STATE_DIR`, the `nodes/` folder moves with it.

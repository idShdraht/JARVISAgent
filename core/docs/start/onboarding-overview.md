---
summary: "Overview of JARVIS onboarding options and flows"
read_when:
...
JARVIS supports multiple onboarding paths depending on where the Gateway runs
...
- [`jarvis onboard` command](/cli/onboard)

## macOS app onboarding

Use the JARVIS app when you want a fully guided setup on macOS. Docs:

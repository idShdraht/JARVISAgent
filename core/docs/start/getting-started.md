---
summary: "Get JARVIS installed and run your first chat in minutes."
read_when:
...
<Info>
Fastest chat: open the Control UI (no channel setup needed). Run `jarvis dashboard`
and chat in the browser, or open `http://127.0.0.1:18789/` on the
<Tooltip headline="Gateway host" tip="The machine running the JARVIS gateway service.">gateway host</Tooltip>.
...
<Steps>
  <Step title="Install JARVIS (recommended)">
    <Tabs>

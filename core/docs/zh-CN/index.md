...
read_when:
  - 向新用户介绍 JARVIS
summary: JARVIS 是一个多渠道 AI 智能体 Gateway 网关，可在任何操作系统上运行。
title: JARVIS
x-i18n:
...
<Columns>
  <Card title="入门指南" href="/start/getting-started" icon="rocket">
    安装 JARVIS 并在几分钟内启动 Gateway 网关。
  </Card>
  <Card title="运行向导" href="/start/wizard" icon="sparkles">
    通过 `jarvis onboard` 和配对流程进行引导式设置。
  </Card>
...
JARVIS 通过单个 Gateway 网关进程将聊天应用连接到 Pi 等编程智能体。它为 JARVIS 助手提供支持，并支持本地或远程部署。

---
summary: "JARVIS macOS companion app (menu bar + gateway broker)"
read_when:
...
# JARVIS macOS Companion (menu bar + gateway broker)

The macOS app is the **menu‑bar companion** for JARVIS. It owns permissions,
...
- **Local** (default): the app attaches to a running local Gateway if present;
  otherwise it enables the launchd service via `jarvis gateway install`.
...
1. Install and launch **JARVIS.app**.
...
Tip: compare against `jarvis gateway discover --json` to see whether the

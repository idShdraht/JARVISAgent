---
summary: "Setup guide for developers working on the JARVIS macOS app"
read_when:
...
This guide covers the necessary steps to build and run the JARVIS macOS application from source.
...
To build the macOS app and package it into `dist/JARVIS.app`, run:

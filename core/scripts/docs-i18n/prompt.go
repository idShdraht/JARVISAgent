...
- Keep product names in English: JARVIS, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the JARVIS Gateway, use “Gateway 网关”.

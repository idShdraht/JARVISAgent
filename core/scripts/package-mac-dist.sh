...
# Output:
# - dist/JARVIS.app
# - dist/JARVIS-<version>.zip
# - dist/JARVIS-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.jarvis.mac}"
...
ZIP="$ROOT_DIR/dist/JARVIS-$VERSION.zip"
DMG="$ROOT_DIR/dist/JARVIS-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/JARVIS-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/JARVIS-$VERSION.dSYM.zip"

    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["jarvis channels list", "List configured channels and auth profiles."],
          ["jarvis channels status --probe", "Run channel status checks and probes."],
          [
            "jarvis channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["jarvis channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.jarvis.ai/cli/channels",
        )}\n`,
    );

    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ...
          ['jarvis memory search --query "deployment notes"', "Search indexed memory entries."],
          ["jarvis memory status --json", "Output machine-readable JSON."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/memory", "docs.jarvis.ai/cli/memory")}\n`,
    );

...
${formatHelpExamples([
  ['jarvis agent --to +15555550123 --message "status update"', "Start a new session."],
  ['jarvis agent --agent ops --message "Summarize logs"', "Use a specific agent."],
  [
  ...
  ['jarvis agent --to +15555550123 --message "Summon reply" --deliver', "Deliver reply."],
  [

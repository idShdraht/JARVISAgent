    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["jarvis directory self --channel slack", "Show the connected account identity."],
          [
            'jarvis directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["jarvis directory groups list --channel discord", "List available groups/channels."],
          [
            "jarvis directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.jarvis.ai/cli/directory",
        )}\n`,
    )
    .action(() => {

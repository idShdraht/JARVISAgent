...
describe("system-presence version fallback", () => {
  it("uses JARVIS_SERVICE_VERSION when JARVIS_VERSION is not set", async () => {
  ...
  it("prefers JARVIS_VERSION over JARVIS_SERVICE_VERSION", async () => {
    await withPresenceModule(
      {
  ...
  it("uses npm_package_version when JARVIS_VERSION and JARVIS_SERVICE_VERSION are blank", async () => {
    await withPresenceModule(
      {
        JARVIS_VERSION: " ",

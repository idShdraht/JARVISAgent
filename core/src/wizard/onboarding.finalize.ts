...
export async function finalizeOnboardingWizard(
  ...
  if (!opts.skipUi && gatewayProbe.ok) {
    ...
    await prompter.note(
      [
        ...
        "Web UI stores a copy in this browser's localStorage (jarvis.control.settings.v1).",
  ...
  await prompter.note(
    [
      ...
      "Docs: https://docs.jarvis.ai/concepts/agent-workspace",
    ].join("\n"),
    "Workspace backup",
  );
  ...
  await prompter.note(
    hasWebSearchKey
      ...
      : [
          ...
          "",
          "JARVIS uses Brave Search for the `web_search` tool. Without a Brave Search API key, web search won’t work.",
          "",
          "Set it up interactively:",
          `- Run: ${formatCliCommand("jarvis configure --section web")}`,

...
export function isAcpEnabledByPolicy(cfg: JARVISConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: JARVISConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: JARVISConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: JARVISConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: JARVISConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: JARVISConfig, agentId: string): boolean {

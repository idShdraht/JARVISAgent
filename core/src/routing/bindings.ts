...
export function listBindings(cfg: JARVISConfig): AgentBinding[] {
...
export function listBoundAccountIds(cfg: JARVISConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: JARVISConfig) {

...
function mergeSlackAccountConfig(cfg: JARVISConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: JARVISConfig): ResolvedSlackAccount[] {

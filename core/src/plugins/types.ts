...
export type JARVISPluginConfigSchema = {
...
export type JARVISPluginToolContext = {
  config?: JARVISConfig;
  workspaceDir?: string;
  agentDir?: string;
  agentId?: string;
...
export type JARVISPluginToolFactory = (
  ctx: JARVISPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type JARVISPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type JARVISPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type JARVISPluginGatewayMethod = {
  method: string;
...
export type JARVISPluginHttpHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean> | boolean;

export type JARVISPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<void> | void;

export type JARVISPluginCliContext = {
  program: Command;
  config: JARVISConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type JARVISPluginCliRegistrar = (ctx: JARVISPluginCliContext) => void | Promise<void>;

export type JARVISPluginServiceContext = {
  config: JARVISConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type JARVISPluginService = {
  id: string;
  start: (ctx: JARVISPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: JARVISPluginServiceContext) => void | Promise<void>;
};

export type JARVISPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type JARVISPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  ...
  register?: (api: JARVISPluginApi) => void | Promise<void>;
  activate?: (api: JARVISPluginApi) => void | Promise<void>;
};

export type JARVISPluginModule =
  | JARVISPluginDefinition
  | ((api: JARVISPluginApi) => void | Promise<void>);

export type JARVISPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | JARVISPluginToolFactory,
    opts?: JARVISPluginToolOptions,
  ) => void;
  registerHook: (
    events: string | string[],
    handler: InternalHookHandler,
    opts?: JARVISPluginHookOptions,
  ) => void;
  registerHttpHandler: (handler: JARVISPluginHttpHandler) => void;
  registerHttpRoute: (params: { path: string; handler: JARVISPluginHttpRouteHandler }) => void;
  registerChannel: (registration: JARVISPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: JARVISPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: JARVISPluginService) => void;

...
export const PLUGIN_MANIFEST_FILENAME = "jarvis.plugin.json";
...
// package.json "jarvis" metadata (used for onboarding/catalog)
...
export type JARVISPackageManifest = {
  extensions?: string[];
...
): JARVISPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }

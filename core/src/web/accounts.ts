...
export function listWhatsAppAuthDirs(cfg: JARVISConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: JARVISConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: JARVISConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: JARVISConfig): ResolvedWhatsAppAccount[] {

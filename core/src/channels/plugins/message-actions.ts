...
export function listChannelMessageActions(cfg: JARVISConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: JARVISConfig): boolean {
...
export function supportsChannelMessageCards(cfg: JARVISConfig): boolean {

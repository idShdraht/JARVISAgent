...
export type ChannelAgentToolFactory = (params: { cfg?: JARVISConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: JARVISConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: JARVISConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: JARVISConfig }) => boolean;
  supportsCards?: (params: { cfg: JARVISConfig }) => boolean;

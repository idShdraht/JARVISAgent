...
import { discoverJARVISPlugins } from "../../plugins/discovery.js";
import type { JARVISPackageManifest } from "../../plugins/manifest.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, JARVISPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["JARVIS_PLUGIN_CATALOG_PATHS", "JARVIS_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<JARVISPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: JARVISPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverJARVISPlugins({ workspaceDir: options.workspaceDir });

...
type SecretDefaults = NonNullable<JARVISConfig["secrets"]>["defaults"];
...
function collectCandidateAgentDirs(config: JARVISConfig): string[] {
  const dirs = new Set<string>();
  dirs.add(resolveUserPath(resolveJARVISAgentDir()));

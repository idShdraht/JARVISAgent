...
function resolveResolutionLimits(config: JARVISConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: JARVISConfig): SecretProviderConfig {

...
function resolveDefaultAccountId(cfg: JARVISConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: JARVISConfig): boolean {
...
export function summarizeBindings(cfg: JARVISConfig, bindings: AgentBinding[]): string[] {

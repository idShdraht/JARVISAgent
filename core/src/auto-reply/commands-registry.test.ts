...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@jarvis", { botUsername: "jarvis" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@jarvis args", {
        botUsername: "jarvis",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "jarvis" })).toBe(
      "/help@otherbot",
    );
  });

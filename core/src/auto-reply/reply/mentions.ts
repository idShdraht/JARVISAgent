...
function resolveMentionPatterns(cfg: JARVISConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: JARVISConfig | undefined, agentId?: string): RegExp[] {

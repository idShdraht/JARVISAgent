...
import { type JARVISConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: JARVISConfig): string[] {
...
export function listAgentsForGateway(cfg: JARVISConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: JARVISConfig): string {
...
function resolveSessionStoreAgentId(cfg: JARVISConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: JARVISConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: JARVISConfig): GatewaySessionsDefaults {

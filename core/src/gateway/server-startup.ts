...
import type { loadJARVISPlugins } from "../plugins/loader.js";
...
export async function startGatewaySidecars(params: {
  ...
  pluginRegistry: ReturnType<typeof loadJARVISPlugins>;
  ...
  // Start JARVIS browser control server (unless disabled via config).

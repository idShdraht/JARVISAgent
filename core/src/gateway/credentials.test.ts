...
function cfg(input: Partial<JARVISConfig>): JARVISConfig {
  return input as JARVISConfig;
}

type ResolveFromConfigInput = Parameters<typeof resolveGatewayCredentialsFromConfig>[0];
type GatewayConfig = NonNullable<JARVISConfig["gateway"]>;
...
const DEFAULT_GATEWAY_ENV = {
  JARVIS_GATEWAY_TOKEN: "env-token",
  JARVIS_GATEWAY_PASSWORD: "env-password",

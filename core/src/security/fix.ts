...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof JARVISConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: JARVISConfig; env: NodeJS.ProcessEnv }): {
  cfg: JARVISConfig;
  changes: string[];
  policyFlips: Set<string>;
} {

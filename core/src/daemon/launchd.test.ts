...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.jarvis.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", JARVIS_PROFILE: "default" },
    });
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.jarvis.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when JARVIS_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.jarvis.gateway.plist",
    },
    {
      name: "uses profile-specific label when JARVIS_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", JARVIS_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.jarvis.jbphoenix.plist",
    },
    {
      name: "prefers JARVIS_LAUNCHD_LABEL over JARVIS_PROFILE",
      env: {
        HOME: "/Users/test",
        JARVIS_PROFILE: "jbphoenix",
        JARVIS_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from JARVIS_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        JARVIS_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty JARVIS_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        JARVIS_PROFILE: "myprofile",
        JARVIS_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.jarvis.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {

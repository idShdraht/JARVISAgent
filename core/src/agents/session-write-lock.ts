...
const CLEANUP_STATE_KEY = Symbol.for("jarvis.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("jarvis.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("jarvis.sessionWriteLockWatchdogState");

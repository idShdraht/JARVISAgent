...
function resolveAvatarSource(cfg: JARVISConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: JARVISConfig, agentId: string): AgentAvatarResolution {

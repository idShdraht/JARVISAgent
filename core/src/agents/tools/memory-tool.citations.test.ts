...
function asJARVISConfig(config: Partial<JARVISConfig>): JARVISConfig {
  return config as JARVISConfig;
}

function createToolConfig() {
  return asJARVISConfig({ agents: { list: [{ id: "main", default: true }] } });
}

function createMemoryGetToolOrThrow(config: JARVISConfig = createToolConfig()) {

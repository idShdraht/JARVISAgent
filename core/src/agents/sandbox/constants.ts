...
export const DEFAULT_SANDBOX_IMAGE = "jarvis-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "jarvis-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "jarvis-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "jarvis-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-21-novnc-auth-default";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "jarvis-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "jarvis-sandbox-browser";

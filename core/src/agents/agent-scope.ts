...
type AgentEntry = NonNullable<NonNullable<JARVISConfig["agents"]>["list"]>[number];
...
export function listAgentEntries(cfg: JARVISConfig): AgentEntry[] {
...
export function listAgentIds(cfg: JARVISConfig): string[] {
...
export function resolveDefaultAgentId(cfg: JARVISConfig): string {
  const agents = listAgentEntries(cfg);
  if (agents.length === 0) {
    return DEFAULT_AGENT_ID;
  }
...
function resolveAgentEntry(cfg: JARVISConfig, agentId: string): AgentEntry | undefined {
...
export function resolveAgentModelPrimary(cfg: JARVISConfig, agentId: string): string | undefined {
...
export function resolveAgentWorkspaceDir(cfg: JARVISConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
...
export function resolveAgentDir(cfg: JARVISConfig, agentId: string) {
  const id = normalizeAgentId(agentId);

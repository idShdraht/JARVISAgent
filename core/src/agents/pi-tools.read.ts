...
function resolveAdaptiveReadMaxBytes(options?: JARVISReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createJARVISReadTool(base, {
...
export function createJARVISReadTool(
  base: AnyAgentTool,
  options?: JARVISReadToolOptions,
): AnyAgentTool {

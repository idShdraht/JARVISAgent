...
async function resolveContext(config: JARVISConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): JARVISConfig {
  return {
    agents: {
      defaults: {
        sandbox: {

...
function resolveWatchPaths(workspaceDir: string, config?: JARVISConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: JARVISConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: JARVISConfig }) {

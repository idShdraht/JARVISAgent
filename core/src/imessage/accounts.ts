...
function mergeIMessageAccountConfig(cfg: JARVISConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: JARVISConfig): ResolvedIMessageAccount[] {

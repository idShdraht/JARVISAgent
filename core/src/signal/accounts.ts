...
function mergeSignalAccountConfig(cfg: JARVISConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: JARVISConfig): ResolvedSignalAccount[] {

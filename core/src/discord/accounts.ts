...
function mergeDiscordAccountConfig(cfg: JARVISConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: JARVISConfig): ResolvedDiscordAccount[] {

...
export function listZalouserAccountIds(cfg: JARVISConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: JARVISConfig): string {
...
function mergeZalouserAccountConfig(cfg: JARVISConfig, accountId: string): ZalouserAccountConfig {

...
import type { ReplyPayload, JARVISConfig } from "jarvis/plugin-sdk";
import { createReplyPrefixOptions } from "jarvis/plugin-sdk";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as JARVISConfig;

...
Nostr DM channel plugin for JARVIS using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to JARVIS. It enables your bot to:
...
# Configure jarvis to use local relay

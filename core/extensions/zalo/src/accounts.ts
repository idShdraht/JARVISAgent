...
export function listZaloAccountIds(cfg: JARVISConfig): string[] {
...
export function resolveDefaultZaloAccountId(cfg: JARVISConfig): string {
...
function mergeZaloAccountConfig(cfg: JARVISConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: JARVISConfig): ResolvedZaloAccount[] {

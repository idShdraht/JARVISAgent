...
import { resolveChannelMediaMaxBytes, type JARVISConfig } from "jarvis/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: JARVISConfig; accountId?: string }): string[] {

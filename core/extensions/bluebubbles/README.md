...
This directory contains the **BlueBubbles external channel plugin** for JARVIS.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `jarvis/plugin-sdk` helpers.

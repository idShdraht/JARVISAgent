import type { JARVISConfig, PluginRuntime, ResolvedLineAccount } from "jarvis/plugin-sdk";
...
function createRuntime(): { runtime: PluginRuntime; mocks: LineRuntimeMocks } {
  ...
  const resolveLineAccount = vi.fn(
    ({ cfg, accountId }: { cfg: JARVISConfig; accountId?: string }) => {
...
async function runLogoutScenario(params: { cfg: JARVISConfig; accountId: string }): Promise<{

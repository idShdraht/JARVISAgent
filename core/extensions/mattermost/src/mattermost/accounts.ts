...
export function listMattermostAccountIds(cfg: JARVISConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: JARVISConfig): string {
...
export function listEnabledMattermostAccounts(cfg: JARVISConfig): ResolvedMattermostAccount[] {

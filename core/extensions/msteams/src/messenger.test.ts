...
import { SILENT_REPLY_TOKEN, type PluginRuntime } from "jarvis/plugin-sdk";
...
import { resolvePreferredJARVISTmpDir } from "../../../src/infra/tmp-jarvis-dir.js";
import {
  type MSTeamsAdapter,
...
describe("msteams messenger", () => {
  ...
  describe("sendMSTeamsMessages", () => {
    ...
    it("preserves parsed mentions when appending OneDrive fallback file links", async () => {
      const tmpDir = await mkdtemp(path.join(resolvePreferredJARVISTmpDir(), "msteams-mention-"));

...
import ai.jarvis.android.ui.mobileSurface
import ai.jarvis.android.ui.mobileText
import ai.jarvis.android.ui.mobileTextSecondary
import ai.jarvis.android.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.jarvis.android.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.jarvis.android.ui.mobileFontFamily,

...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.jarvis", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other JARVIS windows, but below the system’s pop-up menus.

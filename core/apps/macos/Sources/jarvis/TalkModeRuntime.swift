...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.jarvis", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.jarvis", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [JARVISChatMessage] = messages.compactMap { item in

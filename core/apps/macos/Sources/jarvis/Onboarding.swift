...
enum UIStrings {
    static let welcomeTitle = "Welcome to JARVIS"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "jarvis.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: JARVISChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g jarvis@\(version)"
    }

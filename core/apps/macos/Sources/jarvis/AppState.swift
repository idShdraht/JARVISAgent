...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = JARVISConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = JARVISConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = JARVISConfigFile.loadDict()
            ...
            JARVISConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/jarvis"
        state.remoteCliPath = ""
        return state
    }
}

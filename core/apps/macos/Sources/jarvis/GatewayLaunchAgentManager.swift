...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.jarvis", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".jarvis/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.jarvisCommand(
            subcommand: "gateway",

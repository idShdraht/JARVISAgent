...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.jarvis", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        JARVISPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        JARVISPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }

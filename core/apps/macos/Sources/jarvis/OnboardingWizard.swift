...
private let onboardingWizardLogger = Logger(subsystem: "ai.jarvis", category: "onboarding.wizard")

// MARK: - Swift 6 AnyCodable Bridging Helpers

// Bridge between JARVISProtocol.AnyCodable and the local module to avoid
// Swift 6 strict concurrency type conflicts.

private typealias ProtocolAnyCodable = JARVISProtocol.AnyCodable

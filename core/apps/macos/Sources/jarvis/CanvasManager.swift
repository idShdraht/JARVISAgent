...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.jarvis", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("JARVIS/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__jarvis__/a2ui/").absoluteString + "?platform=macos"
    }

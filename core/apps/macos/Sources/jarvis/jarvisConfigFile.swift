...
enum JARVISConfigFile {
    private static let logger = Logger(subsystem: "ai.jarvis", category: "config")
    ...
    static func stateDirURL() -> URL {
        JARVISPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        JARVISPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-jarvis-config-file",
            "event": "config.write",

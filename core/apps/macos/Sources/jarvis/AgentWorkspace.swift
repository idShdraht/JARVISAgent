...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.jarvis", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return JARVISConfigFile.defaultWorkspaceURL() }

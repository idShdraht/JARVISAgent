...
final class WorkActivityStore {
    ...
    func handleTool(
        ...
        name: String?,
        meta: String?,
        args: [String: JARVISProtocol.AnyCodable]?)
    {
    ...
    private static func buildLabel(
        name: String?,
        meta: String?,
        args: [String: JARVISProtocol.AnyCodable]?) -> String
    {
    ...
    private static func wrapToolArgs(_ args: [String: JARVISProtocol.AnyCodable]?) -> JARVISKit.AnyCodable? {
    ...
    private static func unwrapJSONValue(_ value: Any) -> Any {
        if let dict = value as? [String: JARVISProtocol.AnyCodable] {
            return dict.mapValues { self.unwrapJSONValue($0.value) }
        }
        if let array = value as? [JARVISProtocol.AnyCodable] {

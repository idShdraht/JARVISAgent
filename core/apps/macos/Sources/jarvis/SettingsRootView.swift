...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .jarvisSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? JARVISPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? JARVISPaths.stateDirURL.path
...
extension Notification.Name {
    static let jarvisSelectSettingsTab = Notification.Name("jarvisSelectSettingsTab")
}

...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/jarvis/jarvis") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/jarvis/jarvis")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://jarvis.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "JARVISBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "JARVISBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "JARVISGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "JARVISGitCommit") as? String) ??
            "unknown"
    }

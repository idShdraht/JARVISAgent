...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.jarvis.gateway"
    private static let nodeService = "ai.jarvis.node"
    private static let talkService = "ai.jarvis.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.jarvis.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.jarvis.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first?
            .appendingPathComponent("jarvis-gateway.log")
    }

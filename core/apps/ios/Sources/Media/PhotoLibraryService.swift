...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: JARVISPhotosLatestParams) async throws -> JARVISPhotosLatestPayload {
        ...
        var results: [JARVISPhotoPayload] = []
        ...
        return JARVISPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> JARVISPhotoPayload
    {

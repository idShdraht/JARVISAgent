...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = JARVISLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = JARVISLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.jarvis.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        self.featureToggle(
                            ...
                            help: "Enables voice conversation mode with your connected JARVIS agent.") { newValue in
                        ...
                        HStack(spacing: 8) {
                            ...
                            Button {
                                self.activeFeatureHelp = FeatureHelp(
                                    ...
                                    message: "Controls location permissions for JARVIS. "
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(JARVISLocationMode.off.rawValue)
                            Text("While Using").tag(JARVISLocationMode.whileUsing.rawValue)
                            Text("Always").tag(JARVISLocationMode.always.rawValue)
                        }
                        .labelsHidden()
                        ...
                        self.featureToggle(
                            ...
                            help: "Keeps the screen awake while JARVIS is open.")
                    ...
                    DisclosureGroup("Device Info") {
                        ...
                        LabeledContent("JARVIS", value: DeviceInfoHelper.jarvisVersionString())
                    }
                }
            }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = JARVISLocationMode(rawValue: newValue) else { return }
                Task {

...
public typealias JARVISPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias JARVISPlatformImage = UIImage
#endif

public struct JARVISChatUsageCost: Codable, Hashable, Sendable {
...
public struct JARVISChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: JARVISChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(JARVISChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct JARVISChatMessageContent: Codable, Hashable, Sendable {
...
public struct JARVISChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [JARVISChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: JARVISChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [JARVISChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: JARVISChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(JARVISChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([JARVISChatMessageContent].self, forKey: .content) {
...
public struct JARVISChatHistoryPayload: Codable, Sendable {
...
public struct JARVISSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct JARVISSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [JARVISSessionPreviewItem]
}

public struct JARVISSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [JARVISSessionPreviewEntry]

    public init(ts: Int, previews: [JARVISSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct JARVISChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct JARVISChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct JARVISAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct JARVISChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct JARVISGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct JARVISPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: JARVISPlatformImage?
...
public struct JARVISChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String

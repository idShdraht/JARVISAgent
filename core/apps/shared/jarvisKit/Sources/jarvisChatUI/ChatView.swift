...
@MainActor
public struct JARVISChatView: View {
    public enum Style {
        case standard
        case onboarding
    }
    ...
    private var visibleMessages: [JARVISChatMessage] {
        let base: [JARVISChatMessage]
    ...
    private func mergeToolResults(in messages: [JARVISChatMessage]) -> [JARVISChatMessage] {
    ...
    private func isToolResultMessage(_ message: JARVISChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: JARVISChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: JARVISChatMessage) -> String {

...
public enum JARVISTalkCommand: String, Codable, Sendable {
...
public struct JARVISTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct JARVISTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String

...
public enum JARVISCanvasA2UICommand: String, Codable, Sendable {
...
public struct JARVISCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct JARVISCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
